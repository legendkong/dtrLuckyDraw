...
DISCLAIMER: original source code from [IceLam](https://github.com/icelam). I took his source code and edited the styles for my own use.

<p align="center">
    <img alt="Random Name Picker for Lucky Draw" src="./src/assets/images/dareToRoamLogo.png" width="100" />
</p>
